            ...
            <div className="grid-container-four">
                <div className="personal-project">
                    ...
                    <div className="personal-body">
                        <h3>VamoStore</h3>
                        <p>E-Commerce website to sell football-related clothing such as jersey, training kit and anthem jacket. Made using Laravel 9 <strong>(Still in Progress)</strong> </p>
                    </div>
                ...
                <div className="personal-project">
                    ...
                    <div className="personal-body">
                        ...
                        <p>E-Commerce website to sell universal clothing. Made using react.js and firebase</p>
                    </div>
                    <div className="personal-actions">
