        ...
        return(
            <div className="home">
                ...
                <div id="projects">
                    ...
                    <ProjectSection name={projects.project5.name} title={projects.project5.title} desc={projects.project5.desc} jobs={projects.project5.jobs} img={projects.project5.img} iconColor={projects.project5.iconColor}  url={projects.project5.url} link={projects.project5.link}/>
                    ...
                    {/* <ProjectSection name={projects.project8.name} title={projects.project7.title} desc={projects.project7.desc} jobs={projects.project7.jobs} img={projects.project7.img} iconColor={projects.project7.iconColor}  url={projects.project7.url} link={projects.project7.link}/> */}
                    <ProjectSection name={projects.project8.name} title={projects.project8.title} desc={projects.project8.desc} jobs={projects.project8.jobs} img={projects.project8.img} iconColor={projects.project8.iconColor}  url={projects.project8.url} link={projects.project8.link}/>
                </div>
                <div id="gallery">
